...
OPENAI = bool(os.getenv('OPENAI')) or False
OPENAI_API_KEY = os.getenv('OPENAI_API_KEY')
LLM = os.getenv('LLM') or 'text-davinci-003'
LLM_HOST = os.getenv('LLM_HOST') or 'my-llm-host'
LLM_PORT = os.getenv('LLM_PORT') or '8000'
LLM_TEMP = os.getenv('LLM_TEMP') or 1
N_CTX = os.getenv('N_CTX') or 2048  # LLM max context size
K = os.getenv('K') or 4  # K is how many chunks to return
# Chunk size is the number of characters counted in the chunks
EMBED_CHUNK_SIZE = os.getenv('EMBED_CHUNK_SIZE') or 500
# Chunk Overlap to connect ends of chunks together
EMBED_CHUNK_OVERLAP = os.getenv('EMBED_CHUNK_OVERLAP') or 100
DOC_EMBEDDINGS_LLM = os.getenv('EMBED_CHUNK_OVERLAP') or 'all-MiniLM-L6-v2'
...
def main():
    ...
    openai_api.params.temperature = LLM_TEMP
