...
class openai_api(llm_wrapper):
    ...
    >>> import asyncio; from ogbujipt.llm.wrapper import openai_api
    ...
    def hosted_model(self) -> str:
        ...
        >>> from ogbujipt.llm.wrapper import openai_api
        >>> llm_api = openai_api(base_url='http://localhost:8000')
...
class openai_chat_api(openai_api):
    ...
    >>> import asyncio; from ogbujipt.llm.wrapper import openai_chat_api, prompt_to_chat
...
class llama_cpp_http(llm_wrapper):
    ...
    >>> import asyncio; from ogbujipt.llm.wrapper import llama_cpp_http
    ...
    def hosted_model(self) -> str:
        ...
        >>> from ogbujipt.llm.wrapper import llama_cpp_http
        >>> llm_api = llama_cpp_http(base_url='http://localhost:8000')
        >>> llm_api.hosted_model()
        '/models/TheBloke_WizardLM-13B-V1.0-Uncensored-GGML/wizardlm-13b-v1.0-uncensored.ggmlv3.q6_K.bin'
        '''
...
class llama_cpp_http_chat(llama_cpp_http):
    ...
    >>> import asyncio; from ogbujipt.llm.wrapper import prompt_to_chat, llama_cpp_http_chat
